                  ...
                  >
                    ...
                    {slide.title && (
                      <div className="absolute inset-x-0 top-6 z-10 px-5 text-center md:top-10 md:px-10">
                        <h3
                          className={`mx-auto max-w-3xl text-[20px] font-semibold leading-snug text-white transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] md:text-4xl ${
                            isActive
                        ...
                        {slide.description && (
                          <p
                            className={`mx-auto mt-3 max-w-2xl text-sm text-white/80 transition-all duration-700 delay-150 ease-[cubic-bezier(0.22,1,0.36,1)] md:text-base ${
                              isActive
                                ? "translate-y-0 opacity-100"
                                : "translate-y-8 opacity-0"
                            }`}
